...
export const IskconLogo: React.FC<IskconLogoProps> = ({ className = 'w-10 h-10', size = 40 }) => {
  return (
    <svg
      ...
      aria-label="ISKCON Official Logo"
    >
      <defs>
        <linearGradient id="iskconBg" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <circle cx="50" cy="50" r="48" fill="url(#iskconBg)" stroke="#FFD54F" strokeWidth="2.5" />

      {/* Inner Decorative Golden Ring */}
      <circle cx="50" cy="50" r="43" fill="none" stroke="#FFE082" strokeWidth="1" strokeDasharray="3 2" opacity="0.8" />
      ...
      {/* Central Tilak line / space */}
      <line x1="50" y1="24" x2="50" y2="52" stroke="#FFF9F2" strokeWidth="1.5" strokeLinecap="round" opacity="0.9" />
      ...
      />
      {/* Tulasi central vein */}
      <line x1="50" y1="67" x2="50" y2="76" stroke="#AD1457" strokeWidth="1" strokeLinecap="round" />
